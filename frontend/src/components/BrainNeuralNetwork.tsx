...
function BrainNeuralNetwork() {
  ...
  return (
    <div className="absolute inset-0 pointer-events-none flex items-center justify-center">
      <svg
        className="w-full h-full max-w-2xl max-h-2xl text-blue-500 dark:text-blue-400"
      ...
      >
        ...
        {/* Brain silhouette */}
        <path
          d="M-80 0 C-70 -40, -40 -60, 0 -70 C40 -60, 70 -40, 80 0 C70 40, 40 60, 0 70 C-40 60, -70 40, -80 0"
          fill="none"
          stroke="currentColor"
          strokeWidth="2"
          opacity="0.2"
...
export default function BrainNeuralNetworkBackground({
